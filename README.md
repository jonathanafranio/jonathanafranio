<h1 align="left">Salve! Bem-vindo ao meu Github.</h1>
...
<p align="left">
💻 Desenvolvedor Full Stack com 15 anos de experiência, com foco em arquitetura backend — Laravel, PHP e APIs REST.<br>
🚀 Especializado em construir aplicações robustas e escaláveis, com domínio em modelagem de dados, integrações de sistemas e arquiteturas headless.<br>
⚡ Domínio em PHP, Node.js, MySQL, Git e JavaScript (ES6+). Vue.js e WordPress.<br>
📈 Sempre estudando e explorando novas tecnologias para evoluir como profissional e entregar o melhor resultado possível.
</p>
